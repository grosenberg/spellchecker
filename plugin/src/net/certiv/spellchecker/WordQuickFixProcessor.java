...
// /*
// * @see
/// org.eclipse.jdt.ui.text.java.IQuickFixProcessor#getCorrections(org.eclipse.jdt.ui.text.java.IInvocationContext,org.eclipse.jdt.ui.text.java.IProblemLocation[])
// */
// public IJavaCompletionProposal[] getCorrections(IQuickAssistInvocationContext
/// invocationContext, IProblemLocation[] locations) throws CoreException {
//
// final int threshold=
/// Activator.getDefault().getPreferenceStore().getInt(PreferenceConstants.SPELLING_PROPOSAL_THRESHOLD);
//
// int size= 0;
...
// IQuickAssistInvocationContext context= new TextInvocationContext(sourceViewer,
...
// result= new IJavaCompletionProposal[] { new ChangeCaseProposal(arguments,
...
// }
//
// boolean extendable= !fixed ? (checker.acceptsWords() ||
/// AddWordProposal.canAskToConfigure()) : false;
...
// /*
// * @see
/// org.eclipse.jdt.ui.text.java.IQuickFixProcessor#hasCorrections(org.eclipse.jdt.core.ICompilationUnit,int)
// */
