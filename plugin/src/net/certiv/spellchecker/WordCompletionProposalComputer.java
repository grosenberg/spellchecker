...
// if (checker != null) {
//
// final List<RankedWordProposal> proposals= new
/// ArrayList<RankedWordProposal>(checker.getProposals(candidate,
/// Character.isUpperCase(candidate.charAt(0))));
// final List<ICompletionProposal> result= new
/// ArrayList<ICompletionProposal>(proposals.size());
//
...
//
// result.add(new JavaCompletionProposal(text, start, candidate.length(),
/// JavaPluginImages.get(JavaPluginImages.IMG_CORRECTION_RENAME), text, word.getRank()) {
// /*
// * @see
/// org.eclipse.jdt.internal.ui.text.java.JavaCompletionProposal#validate(org.eclipse.jface.text.IDocument,
...
// return
/// PreferenceConstants.getPreferenceStore().getBoolean(PreferenceConstants.SPELLING_ENABLE_CONTENTASSIST);
// }
//
// /*
// * @see
