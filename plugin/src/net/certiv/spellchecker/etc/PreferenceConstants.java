...
public class PreferenceConstants {
	 ...
	 *                 {@link org.eclipse.ui.texteditor.spelling.SpellingService#PREFERENCE_SPELLING_ENABLED}
	 *                 and
	 *                 {@link org.eclipse.ui.texteditor.spelling.SpellingService#PREFERENCE_SPELLING_ENGINE}
	 * @since 3.0
	 */
	@Deprecated public final static String SPELLING_CHECK_SPELLING = "spelling_check_spelling"; //$NON-NLS-1$

	/**
	 * A named preference that controls whether words containing digits should be skipped
	...
	/**
	 * A named preference that controls whether mixed case words should be skipped during
	 * spell checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	...
	/**
	 * A named preference that controls whether sentence capitalization should be ignored
	 * during spell checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	...
	/**
	 * A named preference that controls whether URLs should be ignored during spell
	 * checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	...
	/**
	 * A named preference that controls whether single letters should be ignored during
	 * spell checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	...
	/**
	 * A named preference that controls whether non-letters at word boundaries should be
	 * ignored during spell checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	 * @since 3.3
	...
	/**
	 * A named preference that controls whether Java strings should be ignored during
	 * spell checking.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	...
	/**
	 * A named preference that controls the number of proposals offered during spell
	 * checking.
	 * <p>
	...
	/**
	 * A named preference that controls the maximum number of problems reported during
	 * spell checking.
	 * <p>
	 * Value is of type {@code Integer}.
	 *
	...
	/**
	 * A named preference that specifies whether spelling dictionaries are available to
	 * content assist. <strong>Note:</strong> This is currently not supported because the
	 * spelling engine cannot return word proposals but only correction proposals.
	 * <p>
	 * Value is of type {@code Boolean}.
	 *
	 * @since 3.0
	...
	public static void initializeDefaultValues(IPreferenceStore store) {
		...
		if (!store.getBoolean(isInitializedKey)) {
			...
			if (locale != null) store.setValue(PreferenceConstants.SPELLING_LOCALE, locale.toString());
		}
		...
		// Note: For backwards compatibility we must use the property and not the
		// workspace default
		...
		/*
		 * XXX: This is currently disabled because the spelling engine cannot return word
