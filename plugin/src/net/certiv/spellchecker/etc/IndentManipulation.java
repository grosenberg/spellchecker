...
public final class IndentManipulation {
	...
	/**
	 * Returns {@code true} if the given character is an indentation character.
	 * Indentation character are all whitespace characters except the line delimiter
	 * characters.
	 *
	 * @param ch the given character
	 * @return Returns {@code true} if this the character is a indent character,
	...
	/**
	 * Returns {@code true} if the given character is a line delimiter character.
	 *
	 * @param ch the given character
	 * @return Returns {@code true} if this the character is a line delimiter character,
	 *             {@code false} otherwise
	 */
	 ...
	 * counted. This method only analyzes the content of {@code line} up to the first
	 ...
	 *                <ul>
	 *                <li>the given {@code indentWidth} is lower than zero</li>
	 *                <li>the given {@code tabWidth} is lower than zero</li>
	 *                <li>the given {@code line} is null</li>
	 *                </ul>
	 */
	 ...
	 * <p>
	 * Tab characters are counted using the given {@code tabWidth} and every other indent
	 * character as one. This method analyzes the content of {@code line} up to the first
	 * non-whitespace character.
	 *
	 * @param line the string to measure the indent of
	...
	/**
	 * Returns the leading indentation string of the given line. Note that the returned
	 * string need not be equal to the leading whitespace as odd spaces are not considered
	...
	/**
	 * Removes the given number of indentation units from a given line. If the line has
	 * less indent than the given indentUnitsToRemove, all the available indentation is
	 * removed. If {@code indentsToRemove <= 0 or indent == 0} the line is returned.
	 *
	...
	public static String trimIndent(String line, int indentUnitsToRemove, int tabWidth, int indentWidth) {
		...
		String trimmed;
		if (start == size) trimmed = "";
		else trimmed = line.substring(start);
	...
	/**
	 * Change the indent of a, possible multiple line, code string. The given number of
	 * indent units is removed, and a new indent string is added.
	 * <p>
	 * The first line of the code will not be changed (It is considered to have no indent
	 * as it might start in the middle of a line).
	 *
	 * @param code the code to change the indent of
	 * @param indentUnitsToRemove the number of indent units to remove from each line
	 *            (except the first) of the given code
	 * @param tabWidth the size of one tab in space equivalents
	 * @param indentWidth the width of one indentation unit in space equivalents
	 * @param newIndentString the new indent string to be added to all lines (except the
	 *            first)
	 * @param lineDelim the new line delimiter to be used. The returned code will contain
	 ...
	 *                <li>the given {@code indentWidth} is lower than zero</li>
	 *                <li>the given {@code tabWidth} is lower than zero</li>
	 *                <li>the given {@code code} is null</li>
	 *                <li>the given {@code indentUnitsToRemove} is lower than zero</li>
	 *                <li>the given {@code newIndentString} is null</li>
	 *                <li>the given {@code lineDelim} is null</li>
	 *                </ul>
	 */
	...
	/**
	 * Returns the text edits retrieved after changing the indentation of a, possible
	 ...
	 *                <li>the given {@code indentWidth} is lower than zero</li>
	 *                <li>the given {@code tabWidth} is lower than zero</li>
	 *                <li>the given {@code source} is null</li>
	 *                <li>the given {@code indentUnitsToRemove} is lower than zero</li>
	 *                <li>the given {@code newIndentString} is null</li>
	 *                </ul>
	 */
	...
	public static ReplaceEdit[] getChangeIndentEdits(String source, int indentUnitsToRemove, int tabWidth,
		...
		try {
			...
			tracker.set(source);
			int nLines = tracker.getNumberOfLines();
			if (nLines == 1) return (ReplaceEdit[]) result.toArray(new ReplaceEdit[result.size()]);
	...
	/*
	 * Returns the index where the indent of the given size ends. Returns <code>-1<code>
	 * if the line isn't prefixed with an indent of the given number of indents.
	 */
	private static int indexOfIndent(CharSequence line, int numberOfIndentUnits, int tabWidth, int indentWidth) {
		...
		if (blanks < spaceEquivalents) return -1;
		return result + 1;
	}
	...
	// * <p>Use {@link org.eclipse.jdt.core.IJavaProject#getOptions(boolean)} to get the
	// most current project options.
	// *
	// * @param options the map to get the formatter settings from.
	// *
	// * @return the tab width
	// * @exception IllegalArgumentException if the given {@code options} is null
	// */
