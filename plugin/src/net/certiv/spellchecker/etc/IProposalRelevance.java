...
public interface IProposalRelevance {
	...
	int CREATE_NON_STATIC_ACCESS_USING_DECLARING_TYPE = 6;
	int CREATE_INDIRECT_ACCESS_TO_STATIC = 6;
	...
	int MAKE_VARIABLE_DECLARATION_FINAL = 5;
	int ADD_MISSING_NLS_TAGS = 5;
	int CREATE_NON_STATIC_ACCESS_USING_INSTANCE_TYPE = 5;
	...
	int ADD_ANNOTATION_BUNDLE = 0;
	int REMOVE_BLOCK_FIX = 0;
