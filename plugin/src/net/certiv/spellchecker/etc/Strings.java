...
public class Strings {
	...
	/**
	 * Adds special marks so that that the given styled Java element label is readable in
	 * a BiDi environment.
	 *
	 * @param styledString the styled string
	 * @return the processed styled string
	...
	/**
	 * Converts the given string into an array of lines. The lines don't contain any line
	...
	// * @since 3.1
	// */
	// public static String trimIndent(String line, int indentsToRemove, IJavaProject
	// project) {
	...
	// * @since 3.1
	// */
	// public static String trimIndent(String line, int indentsToRemove, int tabWidth, int
	// indentWidth) {
	...
	// * @param project the java project from which to get the formatter
	// * preferences, or {@code null} for global preferences
	// * @param considerFirstLine If {@code considerFirstLine} is false the first line
	// will be ignored.
	// * @since 3.1
	// */
	// public static void trimIndentation(String[] lines, IJavaProject project, boolean
	// considerFirstLine) {
	// trimIndentation(lines, CodeFormatterUtil.getTabWidth(project),
	...
	// * @since 3.1
	// */
	// public static String changeIndent(String code, int codeIndentLevel, IJavaProject
	// project, String newIndent, String lineDelim) {
	...
	// }
	//
	// public static String trimIndentation(String source, IJavaProject project, boolean
	// considerFirstLine) {
