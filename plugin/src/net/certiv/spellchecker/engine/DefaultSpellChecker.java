...
public class DefaultSpellChecker implements ISpellChecker {
	...
	protected static boolean isUrl(final String word) {
		...
		for (int index = 0; index < URL_PREFIXES.length; index++) {
			...
			if (word.startsWith(URL_PREFIXES[index])) return true;
		}
		return false;
	}
	...
	/*
	 * @see org.eclipse.spelling.done.ISpellChecker#addDictionary(org.eclipse.spelling.done.
	 * ISpellDictionary)
	 */
	...
	/*
	 * @see
	 * org.eclipse.spelling.done.ISpellChecker#execute(org.eclipse.spelling.ISpellCheckTokenizer)
	 */
