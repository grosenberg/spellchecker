...
public abstract class AbstractSpellDictionary implements ISpellDictionary {
	...
	/*
	 * @see net.certiv.spellchecker.engine.ISpellDictionary#getProposals(java.lang.String,boolean)
	 */
				...
				if (stream != null) {
					...
					while (doRead) {
						try {
							...
							IStatus status= new Status(IStatus.ERROR, Activator.ID_PLUGIN, IStatus.OK, message, ex);
