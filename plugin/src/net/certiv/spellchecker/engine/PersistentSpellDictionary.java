...
public class PersistentSpellDictionary extends AbstractSpellDictionary {
	...
	public void addWord(final String word) {
		...
		try {
			...
			if (byteBuffer.hasArray()) byteArray = byteBuffer.array();
			else {
			...
			// Encoding UTF-16 charset writes a BOM. In which case we need to cut it away
	...
	/*
	 * @see net.certiv.spellchecker.engine.AbstractSpellDictionary#getURL()
	 */
	@Override
