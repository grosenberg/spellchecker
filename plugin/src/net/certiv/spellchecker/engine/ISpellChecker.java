...
public interface ISpellChecker {
	...
	/**
	 * Checks the spelling with the spell check iterator. Implementations must be thread
	 * safe as this may be called inside a reconciler thread.
	 *
	 ...
	 * @param sentence {@code true} iff the proposals should start a sentence,
	...
	/**
	 * Is the specified word correctly spelled? Implementations must be thread safe as
	 * this may be called from within a reconciler thread.
	 *
	 * @param word The word to check its spelling
	 * @return {@code true} iff the word is correctly spelled, {@code false} otherwise
	 */
